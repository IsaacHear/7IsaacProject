...
function IsaacLogCall()
	...
	<td width="50%"><input type="text" pattern="[6,8,9]{1}[0-9]{7}" placeholder="onlynumbers" maxlength="8" name="contactNo" id="contactNo" title="Phone number should start with 6, 8 or 9 and have 8 digit" required></td>
	</tr>
	<tr>
