...
function IsaacLogCall()
	...
	<form name="frmLogCall" method="post" action="dispatch.php" onSubmit="return IsaacLogCall();">
	<table width="45%" border="2" align="center"
	cellpadding="5" cellspacing="5">
	<tr>
	<td width="20%" align="center">Name of Caller:</td>
	<td width="50%"><input type="text" pattern="[a-zA-z][a-zA-Z\s]*" name="callerName" id="callerName"</td>
	</tr>
	<tr>
	<td width="20%" align="center">Contact Number:</td>
	<td width="50%"><input type="text" pattern="[6,8,9]{1}[0-9]{7}" placeholder="onlynumbers" maxlength="8" name="contactNo" id="contactNo" title="Phone number should start with 6, 8 or 9" required></td>
	</tr>
	<tr>
